                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('update-archive.updateArchive') }}" method="POST"
                            ...
                            @csrf
                            @method('POST')
                            <input type="text" name="update_arc_id" value="{{ $get_archive_value->id }}">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    {{-- <input disabled class="form-control" type="text" name="category_id"
                                        value="{{ $get_archive_value->category_id }}"> --}}
                                </div>
                            </div>
