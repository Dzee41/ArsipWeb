...
Route::middleware(['auth'])->group(function () {
    Route::get('/', [App\Http\Controllers\DashboardController::class, 'dashboard'])->name('home');
    ...
    Route::get('documents/preview/{id}/{file}', [ManagementArchiveController::class, 'previewFile'])->name('file.preview');
    Route::get('/file/check/{file}', [ManagementArchiveController::class, 'checkFile'])->name('file.check');
